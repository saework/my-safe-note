    ...
    public class DataContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Note>().HasData(
                new Note { Id = 1, UserId = userId1, Number = 1, Title = "Заметка пользователя 1", BodyLink = Guid.NewGuid(), NotePassword = "", CreateDate = DateTime.Now, LastChangeDate = DateTime.Now },
                new Note { Id = 2, UserId = userId2, Number = 1, Title = "Заметка пользователя 2", BodyLink = Guid.NewGuid(), NotePassword = "", CreateDate = DateTime.Now, LastChangeDate = DateTime.Now }
